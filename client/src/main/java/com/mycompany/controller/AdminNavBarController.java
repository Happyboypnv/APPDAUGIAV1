...
public class AdminNavBarController implements Initializable { // Controller chung cho các trang có thanh điều hướng, để tránh trùng code, giúp dễ bảo trì hơn
    ...
    private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(AdminNavBarController.class);
