...
public class TransactionService {
    ...
    public boolean confirmPayment(Transaction Transaction) {
        ...
        if (Transaction.getStatus() != TransactionStatus.PENDING_PAYMENT) {
            logger.info("[confirmPayment] Trạng thái không hợp lệ: {}", Transaction.getStatus());
            return false;
        }
        ...
        winner.setAvailableBalance(winner.getAvailableBalance() - endPrice);
        seller.setAvailableBalance(seller.getAvailableBalance() + endPrice);
    ...
    // =========================================================
    public boolean refun(Transaction Transaction, String lyDo) {
        if (Transaction == null) {
        ...
        if (Transaction.getStatus() == TransactionStatus.PAID) {
            seller.setAvailableBalance(seller.getAvailableBalance() - refundAmount);
        }

        winner.setAvailableBalance(winner.getAvailableBalance() + refundAmount);
